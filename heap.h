...
/* Se crea un heap a partir de un arreglo y una funcion de comparacion
...
/* Se devuelve el elemento de forma const, de manera que no se pueda editar
 * y romper la estructura interna del heap
 * Pre: El heap fue creado
 ...
 * Post: el arreglo elementos[] queda ordenado de manera
